...
/**
 * 模型 pill 弹出菜单：列出已配置的 API profiles，点击切换 activeProfileId。
 * 复用 setSettings 现有逻辑，不引入新 action。
 */
function ModelMenu({
  anchorRef,
  onClose,
  ...
  return (
    <div
      ...
      aria-modal="true"
      aria-label="切换模型配置"
      className="absolute bottom-full left-0 mb-2 min-w-[220px] max-w-[calc(100vw-2rem)] rounded-2xl border border-gray-200/70 bg-white/95 p-2 shadow-2xl ring-1 ring-black/5 backdrop-blur-xl dark:border-white/[0.08] dark:bg-gray-900/95 dark:ring-white/10 z-40"
    >
